...
| 本地版本 | 2.5.24，已部署；源码及发布记录随本批次提交 |
| 最近已确认生产版本 | 2.5.24 |
| 最近已确认部署 | dpl_HM3vKY4Xep4o4UVfmNDjZkgSbCBW，READY，已绑定生产域名 |
| 最近已确认 Git 提交 | 本文件所在的 2.5.24 发布提交；前一版本提交 5472ba7 |
| 用户使用方式 | Android Chrome 添加到主屏幕的 PWA |
| Android 原生 | Capacitor 8；本地 versionName 2.5.24 / versionCode 142；本批次未构建 APK |
