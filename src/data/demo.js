...
export const demoHoldings = [
  ...
  { assetType: '虚拟币', market: 'GLOBAL', account: 'Binance', symbol: 'ETH', name: 'ETH', currency: 'USD', quantity: 0.0376762, price: 188.5875, marketValue: 71.085, marketValueCNY: 481.257 },
  { assetType: '虚拟币', market: 'GLOBAL', account: 'Binance', symbol: 'BNB', name: 'BNB', currency: 'USD', quantity: 0.01302, price: 57.056, marketValue: 7.429, marketValueCNY: 50.316 },
...
export const demoTarget = [
  ...
  { category: '虚拟币', marketValue: 49919.73, currentRatio: 0.1451, targetRatio: 0.15, diff: -0.0049, isTotal: false },
