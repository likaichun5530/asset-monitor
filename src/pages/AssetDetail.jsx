...
import { isCnAccountHolding, isHkAccountHolding, isUsAccountHolding } from '../utils/holdingScope.js'
...
const ASSET_CONFIG = {
  ...
  cn: { label: 'A股账户', filter: isCnAccountHolding, color: assetColors.A股, showOriginal: false },
